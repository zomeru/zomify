...
<div
	class="flex flex-col sm:flex-row sm:items-end relative mt-[calc(-1*(30px+60px))] -mx-[30px] mb-0 pt-[calc(30px+60px)] px-[30px] pb-5"
>
	<div
		class="banner-gradient absolute top-0 left-0 w-full h-[150%] z-1"
